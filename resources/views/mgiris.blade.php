			...
			<div class="row justify-content-center">
				<div class="col-md-6 col-lg-5">
		      	...
		      	<h3 class="text-center mb-4">Üye Girişi</h3>
						<form method ="post" action="musteriGirisPost" class="login-form">
					@csrf
		      		<div class="form-group">
		      			<input type="text" class="form-control rounded-left" name="e_posta" placeholder="E-Posta" required>
		      		</div>
	            	...
	            	<div class="w-50">
	            		<label class="checkbox-wrap checkbox-primary">Beni Hatırla
								...
								<div class="w-50 text-md-right">
									...
									<a href="musteri_kayit">Hesap Oluştur</a>
								</div>
