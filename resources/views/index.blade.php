...
<body>
    ...
    <!-- ##### Welcome Area Start ##### -->
    <section class="welcome_area bg-img background-overlay" style="background-image: url(img/klimaindex.jpg);">
            ...
            <div class="row h-100 align-items-center">
                <div class="col-12">
                    <div class="hero-content">
                        <h6>Klima</h6>
                        <h2>Yeni Çıkanlar</h2>
                        <a href="#" class="btn essence-btn">Görüntüleyin</a>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="container">
            <div class="row justify-content-center">
                ...
                <div class="col-12 col-sm-6 col-md-4">
                    <div class="single_catagory_area d-flex align-items-center justify-content-center bg-img" style="background-image: url(img/bg-img/resim1.jpg);">
                        <div class="catagory-content">
                            <a href="{{route('salontipi')}}">Salon Tipi Klima</a>
                        </div>
                    </div>
                </div>
                <!-- Single Catagory -->
                <div class="col-12 col-sm-6 col-md-4">
                    <div class="single_catagory_area d-flex align-items-center justify-content-center bg-img" style="background-image: url(img/bg-img/resim2.jpg);">
                        <div class="catagory-content">
                            <a href="tavantipi">Tavan Tipi</a>
                        </div>
                    </div>
                </div>
                <!-- Single Catagory -->
                <div class="col-12 col-sm-6 col-md-4">
                    <div class="single_catagory_area d-flex align-items-center justify-content-center bg-img" style="background-image: url(img/bg-img/resim3.jpg);">
                        <div class="catagory-content">
                            <a href="pano">Pano Klima</a>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <div class="cta-area">
        <div class="container">
            <div class="row">
                <div class="col-12">
                    <div class="cta-content bg-img background-overlay" style="background-image: url(img/bg-img/deneme2.png);">
                        <div class="h-100 d-flex align-items-center justify-content-end">
                            <div class="cta--text">
                                <h6>-60%</h6>
                                <h2>Fırsat Ürünleri </h2>
                                <a href="#" class="btn essence-btn">Satın Al</a>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="popular-products-slides owl-carousel">
                        ...
                        <div class="single-product-wrapper">
                            ...
                            <div class="product-img">
                                <img src="urun_resimler/r1/st1_1.jpg" alt="">
                                <!-- Hover Thumb -->
                                <img class="hover-img" src="urun_resimler/r2/st1_2.jpg" alt="">
                                <!-- Favourite -->
                            ...
                            <div class="product-description">
                                ...
                                <a href="single-product-details.html">
                                    <h6>Hantech 24000 KLIMA/HNT-S24VMYCL/I</h6>
                                </a>
                                <p class="product-price">27.500 TL</p>

                                <!-- Hover Content -->
                                <div class="hover-content">
                                    <!-- Add to Cart -->
                                    <div class="add-to-cart-btn">
                                        <a href="#" class="btn essence-btn">Sepete Ekle</a>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="single-product-wrapper">
                            <!-- Product Image -->
                            <div class="product-img">
                                <img src="urun_resimler/r1/st3_1.jpg" alt="">
                                <!-- Hover Thumb -->
                                <img class="hover-img" src="urun_resimler/r2/st3_2.jpg" alt="">
                                <!-- Favourite -->
                                <div class="product-favourite">
                                    <a href="#" class="favme fa fa-heart"></a>
                                </div>
                            ...
                            <div class="product-description">
                                <span>Baymak</span>
                                <a href="single-product-details.html">
                                    <h6>Baymak FSA 48 Gaz Klima</h6>
                                </a>
                                <p class="product-price">33.999 TL</p>
                        ...
                        <div class="single-product-wrapper">
                            <!-- Product Image -->
                            <div class="product-img">
                                <img src="urun_resimler/r1/st5_1.jpg" alt="">
                                <!-- Hover Thumb -->
                                <img class="hover-img" src="urun_resimler/r2/st5_2.jpg" alt="">
                            ...
                            <div class="product-description">
                                <span>Daikin</span>
                                <a href="single-product-details.html">
                                    <h6>Daikin AVQ125CVE 41250 BTU/H</h6>
                                </a>
                                <p class="product-price"><span class="old-price">57.500 TL</span> 50.000 TL</p>
                        ...
                        <div class="single-product-wrapper">
                            <!-- Product Image -->
                            <div class="product-img">
                                <img src="urun_resimler/r1/st2_1.jpg" alt="">
                                <!-- Hover Thumb -->
                                <img class="hover-img" src="urun_resimler/r2/st2_2.jpg" alt="">
                            ...
                            <div class="product-description">
                                <span>Toshiba</span>
                                <a href="single-product-details.html">
                                    <h6>Toshiba 48 Dı Split Klimaa</h6>
                                </a>
                                <p class="product-price">64.500 TL</p>
