				...
				<div class="col-md-12">
					<div class="wrapper">
						...
						<div class="row">
			        		...
			        		<div class="text">
				            <p><span>Adres:</span> Osmangazi, Kemerçeşme Cd. No:46, 16240 Osmangazi/Bursa</p>
				          </div>
			          </div>
							</div>
							<div class="col-md-3">
			        		...
			        		<div class="text">
				            <p><span>Telefon:</span> +(90) 545 251 23 42</p>
				          </div>
			          </div>
							</div>
							<div class="col-md-3">
			        		...
			        		<div class="text">
				            <p><span>Email:</span> <a href="mailto:info@yoursite.com">klima@gmail.com</a></p>
				          </div>
			          </div>
							</div>
							<div class="col-md-3">
			        		...
			        		<div class="text">
				            <p><span>Website</span> <a href="#">klima.com</a></p>
				          </div>
			          </div>
							</div>
						</div>
...
<script src="js/contactjs/jquery.min.js"></script>
<script src="js/contactjs/popper.js"></script>
<script src="js/contactjs/bootstrap.min.js"></script>
<script src="js/contactjs/jquery.validate.min.js"></script>
<script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyBVWaKrjvy3MaE7SQ74_uJiULgl1JY0H2s&sensor=false"></script>
<script src="js/contactjs/google-map.js"></script>
<script src="js/contactjs/main.js"></script>
