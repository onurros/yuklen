    ...
    <div id="main-wrapper" data-layout="vertical" data-navbarbg="skin5" data-sidebartype="full" data-sidebar-position="absolute" data-header-position="absolute" data-boxed-layout="full">
        ...
        <div class="page-wrapper">
            ...
            <div class="page-breadcrumb bg-white">
                <div class="row align-items-center">
                    <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                        <h4 class="page-title">Ürün Güncelleme Sayfası
                        </h4>
                    </div>
                    <div class="col-lg-9 col-sm-8 col-md-8 col-xs-12">
                        <div class="d-md-flex">
                            <ol class="breadcrumb ms-auto">
                                <li><a href="#" class="fw-normal">Ürün Güncelleme Sayfası</a></li>
                            </ol>
            ...
            <div class="container-fluid">
                <form method="post" action="{{route('urun_Guncelle')}}" class="login-form" enctype="multipart/form-data">
                    @csrf
                    <!-- ============================================================== -->
                    <!-- Start Page Content -->
                    <!-- ============================================================== -->
                                ...
                                <form class="form-horizontal form-material">
                                    <div class="form-group mb-4">
                                        ...
                                        <div class="col-md-12 border-bottom p-0">
                                            <input type="text" value="{{$urun->urun_adi}}" name="urun_adi" class="form-control p-0 border-0" required>
                                        </div>
                                    </div>
                                    <div class="form-group mb-4">
                                        <label class="col-md-12 p-0">Isıtma Kapasitesi</label>
                                        <div class="col-md-12 border-bottom p-0">
                                            <input type="text" value="{{$urun->isitma_kapasitesi}}" name="ikapasite" class="form-control p-0 border-0" required>
                                        </div>
                                    </div>
                                    <div class="form-group mb-4">
                                        <label for="example-email" class="col-md-12 p-0">Soğutma Kapasitesi</label>
                                        <div class="col-md-12 border-bottom p-0">
                                            <input type="text" value="{{$urun->sogutma_kapasitesi}}" name="skapasite" class="form-control p-0 border-0" required>
                                        </div>
                                    </div>
                                    <div class="form-group mb-4">
                                        <label for="example-email" class="col-md-12 p-0">Enerji Sınıfı</label>
                                        <div class="col-md-12 border-bottom p-0">
                                            <input type="text" value="{{$urun->enerji_sinifi}}" class="form-control p-0 border-0" name="esinifi" required>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group mb-4">
                                        ...
                                        <div class="col-md-12 border-bottom p-0">
                                            <input type="text" value="{{$urun->ses_seviyesi}}" class="form-control p-0 border-0" name="ses_seviyesi" required>
                                        </div>
                                    </div>
                                    <div class="form-group mb-4">
                                        <label class="col-md-12 p-0">Renk</label>
                                        <div class="col-md-12 border-bottom p-0">
                                            <input type="text" value="{{$urun->renk}}" name="renk" class="form-control p-0 border-0" required>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group mb-4">
                                        ...
                                        <div class="col-sm-12 border-bottom">
                                            ...
                                            <option >{{$u_marka->marka_adi}}</option>
                                    ...
                                    <div class="form-group mb-4">
                                        ...
                                        <div class="col-md-12 border-bottom p-0">
                                            <input type="text" value="{{$urun->stok}}" name="stok" class="form-control p-0 border-0" required>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group mb-4">
                                        ...
                                        <div class="col-md-12 border-bottom p-0">
                                            <input type="text" value="{{$urun->fiyat}}" name="fiyat" class="form-control p-0 border-0" required>
                                        </div>
                                    </div>
                ...
                <form method="post" action="{{route('urun_resim_Guncelle')}}" class="login-form" enctype="multipart/form-data">
                    @csrf
                    <!-- ============================================================== -->
                    <!-- Start Page Content -->
                    <!-- ============================================================== -->
                            ...
                            <div class="card-body">
                                <form class="form-horizontal form-material">
                                      ...
                                      <div class="form-group mb-4">
                                        ...
                                        <div class="col-md-12 border-bottom p-0">
                                            <input type="file" value="{{$urun->fiyat}}"  name="r1" class="form-control p-0 border-0" required>
                                    ...
                                    <div class="form-group mb-4">
                                        ...
                                        <input type="hidden" name="admin" value="{{$admin->id}}">
                                        <input type="hidden" name="urunid" value="{{$urun->urun_id}}">
                                            <button type="submit" class="btn btn-success">Resim Güncelle</button>
                                        </div>
                                    </div>
                                </form>
                            </div>
